...
**易达熊打字**（drop-typing）是易达熊公司旗下的开源子产品线，一款面向 macOS 的语音输入工具。我们坚持以开源为核心，后续也会提供商业化版本——主要面向希望即开即用的用户，提供更加便捷的云端语音识别与大模型接入能力。商业化版本与开源版本在核心体验上没有本质区别。
...
- 倒计时时长可配置：`command_countdown_ms`（默认 2000）
